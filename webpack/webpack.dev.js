        ...
        devServer: {
            ...
            proxy: {
                '/mock/api/': {
                    ...base,
                    // target: `${host}:${port}`,
                    target: 'http://6a.bdp.jd.com/'
                },
                '/customPolicy': { ...base, target: 'http://6a.bdp.jd.com/' },
                '/sagCouponInternal': { ...base, target: 'http://6a.bdp.jd.com/' },
                '/leoauto': { ...base, target: 'http://6a.bdp.jd.com/' },
                '/scoreport': { ...base, target: 'http://6a.bdp.jd.com/' },
                '/local/api/': {
                    ...base,
